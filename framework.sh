...
#If this script is giving errors (It's probably been edited on Windows), install dos2unix and write the command "dos2unix scriptname.sh"
...
# create swapfile (not neccesary with archinstall)
